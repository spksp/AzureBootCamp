...
// defines a route that receives the post request to /deleteEvents
app.post('/deleteEvents',
    urlencodedParser, // second argument - how to parse the uploaded content
    // into req.body
    (req, res) => {
        // make a request to the backend microservice using the request package
        ...
        request.post(  // first argument: url + data + formats
            {
                url: SERVER + '/deleteEvents',  // the microservice end point for adding an event
                body: req.body,  // content of the form
                headers: { // uploading json
                    "Content-Type": "application/json"
                },
...
app.post('/deleteRecentEvent',
    ...
    (req, res) => {
        ...
        request.post(  // first argument: url + data + formats
            {
                url: SERVER + '/deleteRecentEvent',  // the microservice end point for adding an event
                body: req.body,  // content of the form
                headers: { // uploading json
                    "Content-Type": "application/json"
                },
